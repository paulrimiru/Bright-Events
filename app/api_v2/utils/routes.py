...
restful.add_resource(funcs.Events, '/events', endpoint='api_v2.events')
...
restful.add_resource(funcs.SearchEvent, '/events/search')
restful.add_resource(funcs.RsvpManage, '/events/rsvp')
